...
{
    private_nh_.param("scan_topic_name_",scan_topic_name_,{"/scan"});
    private_nh_.param("map_topic_name_",map_topic_name_,{"/map"});
    private_nh_.param("est_pose_topic_name_",est_pose_topic_name_,{"est_pose"});
    private_nh_.param("est_poses_topic_name_",est_poses_topic_name_,{"est_poses"});
    private_nh_.param("map_frame_id",map_frame_id_,{"map"});
    private_nh_.param("odom_frame_id_",odom_frame_id_,{"odom"});
    private_nh_.param("base_link_frame_id_",base_link_frame_id_,{"base_link"});

    private_nh_.param("NUM_OF_PARTICLES_",NUM_OF_PARTICLES_,{2000});
    private_nh_.param("INIT_X_",INIT_X_,{7.0});
    private_nh_.param("INIT_Y_",INIT_Y_,{0.0});
    private_nh_.param("INIT_YAW_",INIT_YAW_,{1.5708});
    private_nh_.param("INIT_X_COV_",INIT_X_COV_,{0.5});
    private_nh_.param("INIT_Y_COV_",INIT_Y_COV_,{0.5});
    private_nh_.param("INIT_YAW_COV_",INIT_YAW_COV_,{0.5});
    private_nh_.param("MAX_RANGE_",MAX_RANGE_,{25});
    private_nh_.param("RANGE_STEP_",RANGE_STEP_,{5});
    private_nh_.param("X_COV_TH_",X_COV_TH_,{0.15});
    private_nh_.param("Y_COV_TH_",Y_COV_TH_,{0.15});
    private_nh_.param("YAW_COV_TH_",YAW_COV_TH_,{0.10});
    private_nh_.param("ALPHA_1_",ALPHA_1_,{0.3});
    private_nh_.param("ALPHA_2_",ALPHA_2_,{0.3});
    private_nh_.param("ALPHA_3_",ALPHA_3_,{0.1});
    private_nh_.param("ALPHA_4_",ALPHA_4_,{0.1});
    private_nh_.param("ALPHA_SLOW_",ALPHA_SLOW_,{0.001});
    private_nh_.param("ALPHA_FAST_",ALPHA_FAST_,{0.1});
    private_nh_.param("HIT_COV_",HIT_COV_,{1.0});
    private_nh_.param("LAMBDA_SHORT_",LAMBDA_SHORT_,{0.1});
    private_nh_.param("Z_HIT_",Z_HIT_,{0.95});
    private_nh_.param("Z_SHORT_",Z_SHORT_,{0.1});
    private_nh_.param("Z_MAX_",Z_MAX_,{0.05});
    private_nh_.param("Z_RAND_",Z_RAND_,{0.05});
    private_nh_.param("DISTANCE_TH_",DISTANCE_TH_,{0.15});
    private_nh_.param("ANGLE_TH_",ANGLE_TH_,{0.15});
    private_nh_.param("SELECTION_RATE_",SELECTION_RATE_,{0.2});
